        ...
        <section>
            <div className="max-w-7xl">
                <div className=" max-w-2xl text-left">
                    ...
                    <h1 className="!leading-normal mt-6 text-3xl font-bold text-over text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-green-400 sm:text-2xl lg:text-5xl">{heroTitle}</h1>
